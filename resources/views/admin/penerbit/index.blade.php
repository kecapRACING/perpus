...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="{{ route('penerbit.create') }}" class="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-lg shadow-md hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-700 transition duration-300">
